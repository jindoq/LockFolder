...
public extension DKAsset {
     ...
     */
    public func writeImageToFile(_ path: String, completeBlock: @escaping (_ success: Bool, _ filePath: String) -> Void) {
		let options = PHImageRequestOptions()
		options.version = .current
     ...
     */
	public func writeAVToFile(_ path: String, presetName: String, completeBlock: @escaping (_ success: Bool, _ filePath: String) -> Void) {
            ...
            DKAssetWriter.writeQueue.addOperation({
                if let avAsset = avAsset,
                    ...
                    exportSession.exportAsynchronously(completionHandler: {
                        completeBlock(exportSession.status == .completed ? true : false, path)
                    })
                } else {
                    completeBlock(false, path)
                }
